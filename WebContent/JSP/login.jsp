	                            ...
	                            <div class="box-body">
	                                ...
	                                <div class="row">
	                                    <div class="form-group col-md-11">
	                                        ...
	                                        <input type="email" class="form-control" name="emailSouCadastrado" placeholder="E-mail">
	                                    </div>
	                                </div>
	                                <div class="row">
	                                    <div class="form-group col-md-11">
	                                        <label for="txtSenha">Senha</label>
	                                        <input type="password" class="form-control" name="senhaSouCadastrado" placeholder="Senha">
	                                    </div>
	                                </div>
	                                <div class="row">
	                            ...
	                            <div class="box-body">
	                                ...
	                                <div class="row">
	                                    <div class="form-group col-md-6">
	                                        ...
	                                        <input type="text" class="form-control" name="nomeNaoSouCadastrado" placeholder="Nome">
	                                    </div>
	                                    <div class="form-group col-md-6">
	                                        <label for="exampleInput">Telefone</label>
	                                        <input type="tel" class="form-control" name="telefoneNaoSouCadastrado" placeholder="Telefone">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="row">
	                                    <div class="form-group col-md-10">
	                                        ...
	                                        <input type="email" class="form-control" name="emailNaoSouCadastrado" placeholder="E-mail">
	                                    </div>
	                                </div>
	                                <div class="row">
	                                    <div class="form-group col-md-10">
	                                        <label for="exampleInput">Senha</label>
	                                        <input type="password" class="form-control col-md-10" name="senhaNaoSouCadastrado" placeholder="Senha">
	                                    </div>
	                                </div>
	                                <div class="row">
	                                    <div class="form-group col-md-10">
	                                        <label for="exampleInput">Confirmar senha</label>
	                                        <input type="password" class="form-control col-md-10" name="confirmarSenhaNaoSouCadastrado" placeholder="Confirmar senha">
	                                    </div>
	                                </div>
	                                <!-- QUINTA LINHA -->
	                                <div class="row">
