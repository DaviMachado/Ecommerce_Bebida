...
/**
 * Classe para validar o campo codigo de segurança do Cartão de Credito
...
public class ValidarCodigoSegurancaCartao implements IStrategy {
	...
	public String validar(EntidadeDominio entidade) {
		...
		if(cartao.getAlteraCartao().contentEquals("1")) {
			if(cartao.getCod_seguranca() == null || cartao.getCod_seguranca().equals("")) {
				return "Favor insira um codigo de segurança no Cartão de Crédito.";
			}
			else {
				return null;
			}
