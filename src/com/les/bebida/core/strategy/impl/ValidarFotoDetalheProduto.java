...
/**
 * Classe para validar o campo foto detalhe do Produto
 * @author Davi Rodrigues
 * @date 15/10/2021
 */
public class ValidarFotoDetalheProduto implements IStrategy {
	...
	public String validar(EntidadeDominio entidade) {
		...
		if(produto.getAlteraProduto().contentEquals("1")) {
			if(produto.getFotoDetalhe() == null || produto.getFotoDetalhe().equals("")) {
				return "Favor insira uma foto para o detalhe do Produto.";
			}
			else {
				return null;
			}
