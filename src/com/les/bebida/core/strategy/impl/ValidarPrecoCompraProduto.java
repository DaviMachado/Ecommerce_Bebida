...
/**
 * Classe para validar o campo preço de compra do Produto
 * @author Davi Rodrigues
 * @date 24/08/2021
 */
public class ValidarPrecoCompraProduto implements IStrategy {
	...
	public String validar(EntidadeDominio entidade) {
		...
		if(produto.getAlteraProduto().contentEquals("1")) {
			if(produto.getPrecoDeCompra() == null || produto.getPrecoDeCompra().equals("")) {
				return "Favor insira um preço de compra no Produto.";
			}
			else {
				return null;
			}
